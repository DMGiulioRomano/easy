...
def make_params(**overrides):
    """Parametri minimi validi per costruire una Cartridge."""
    base = {
...
class TestInit:
    """Test costruttore Cartridge - attributi obbligatori."""

    def test_stores_cartridge_id(self):
        """cartridge_id viene salvato correttamente."""
        t = Cartridge(make_params(cartridge_id='my_head'))
        assert t.cartridge_id == 'my_head'

    def test_stores_onset(self):
        """onset viene salvato correttamente."""
        t = Cartridge(make_params(onset=3.14))
        assert t.onset == 3.14

    def test_stores_duration(self):
        """duration viene salvata correttamente."""
        t = Cartridge(make_params(duration=12.5))
        assert t.duration == 12.5

    def test_stores_sample_path(self):
        """sample_path viene estratto da 'sample'."""
        t = Cartridge(make_params(sample='path/to/tape.wav'))
...
class TestToScoreLineValues:
    ...
    def test_onset_value(self):
        ...
        t = Cartridge(make_params(onset=2.5))
        t.sample_table_num = 1
    ...
    def test_duration_value(self):
        ...
        t = Cartridge(make_params(duration=10.0))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_start_position_value(self):
        ...
        t = Cartridge(make_params(start_position=1.5))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_speed_value(self):
        ...
        t = Cartridge(make_params(speed=2.0))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_volume_value(self):
        ...
        t = Cartridge(make_params(volume=-6.0))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_pan_value(self):
        ...
        t = Cartridge(make_params(pan=0.25))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
...
class TestToScoreLineLoop:
    ...
    def test_loop_false_produces_flag_0(self):
        ...
        t = Cartridge(make_params(loop=False))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_loop_end_none_produces_minus_one(self):
        ...
        t = Cartridge(make_params(loop_end=None))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_loop_end_explicit_value(self):
        ...
        t = Cartridge(make_params(loop_end=3.5))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_loop_start_explicit_in_score(self):
        ...
        t = Cartridge(make_params(loop_start=2.0))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_loop_start_none_produces_minus_one(self):
        ...
        t = Cartridge(make_params(loop_start=None))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_full_loop_configuration(self):
        ...
        t = Cartridge(make_params(loop=True, loop_start=1.0, loop_end=4.0))
...
class TestToScoreLineFormatting:
    ...
    def test_onset_six_decimal_places(self):
        ...
        t = Cartridge(make_params(onset=1.0))
        t.sample_table_num = 1
        line = t.to_score_line()
    ...
    def test_duration_six_decimal_places(self):
        ...
        t = Cartridge(make_params(duration=5.0))
        t.sample_table_num = 1
        line = t.to_score_line()
    ...
    def test_volume_two_decimal_places(self):
        ...
        t = Cartridge(make_params(volume=0.0))
        t.sample_table_num = 1
        line = t.to_score_line()
        assert '0.00' in line
    ...
    def test_pan_three_decimal_places(self):
        ...
        t = Cartridge(make_params(pan=0.5))
        t.sample_table_num = 1
        line = t.to_score_line()
    ...
    def test_default_score_line_exact(self):
        ...
        t = Cartridge(make_params(onset=0.0, duration=5.0))
        t.sample_table_num = 1
        expected = (
...
class TestRepr:
    """Test sulla rappresentazione stringa della Cartridge."""

    def test_repr_contains_id(self):
        """__repr__ contiene cartridge_id."""
        t = Cartridge(make_params(cartridge_id='head_A'))
        assert 'head_A' in repr(t)

    def test_repr_contains_onset(self):
        """__repr__ contiene onset."""
        t = Cartridge(make_params(onset=3.0))
        assert '3.0' in repr(t)

    def test_repr_contains_duration(self):
        """__repr__ contiene duration."""
        t = Cartridge(make_params(duration=7.5))
    ...
    def test_repr_contains_cartridge_class_name(self):
        """__repr__ contiene il nome della classe."""
        t = Cartridge(make_params())
        assert 'Cartridge' in repr(t)
...
class TestEdgeCases:
    ...
    def test_onset_zero(self):
        """onset=0.0 e' valido."""
        t = Cartridge(make_params(onset=0.0))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_very_long_duration(self):
        ...
        t = Cartridge(make_params(duration=3600.0))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_speed_zero(self):
        ...
        t = Cartridge(make_params(speed=0.0))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_fractional_onset(self):
        ...
        t = Cartridge(make_params(onset=0.123456789))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
    ...
    def test_loop_flag_independent_of_start_end(self):
        ...
        t = Cartridge(make_params(loop=False, loop_start=1.0, loop_end=3.0))
        t.sample_table_num = 1
        parsed = parse_score_line(t.to_score_line())
        assert parsed['loop_flag'] == 0
